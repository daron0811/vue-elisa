        ...
        <div class="panel__row three">
            ...
            <div class="mini">
                ...
                <table class="tbl">
                    ...
                    <tbody>
                        <tr v-for="i in uIdx" :key="'U' + i">
                            <td>U{{ i }}</td>
                            <td><input class="ipt" type="number" min="1" step="1" :value="uVal(i)"
                                    @input="(e) => onDilInput('U', i, e)" /></td>
                        </tr>
                        <tr v-for="i in cIdx" :key="'C' + i">
                            <td>C{{ i }}</td>
                            <td><input class="ipt" type="number" min="1" step="1" :value="cVal(i)"
                                    @input="(e) => onDilInput('C', i, e)" /></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
.range-grid {
    display: grid;
    grid-template-columns: auto 10rem auto 8rem auto 8rem auto 10rem auto;
    gap: .5rem .75rem;
    align-items: center;
}
